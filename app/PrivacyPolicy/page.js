...
<p className="text-sm mdl:text-lg mt-2">Last updated: 0/0/2024</p>


<p className="mt-5 mdl:mt-12">Welcome to imaginmaker!
This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.
</p>
<h1 className="text-2xl py-6 mdl:text-3xl text-white">Interpretation and Definitions</h1>
<h1 className="text-xl pb-4 mdl:text-2xl text-white">Interpretation </h1>

<p >The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>

<h1 className="text-xl py-2 mdl:text-2xl text-white">Definitions</h1>

<p>For the purposes of this Privacy Policy:
Account means a unique account created for You to access our Service or parts of our Service.
Affiliate means an entity that controls, is controlled by or is under common control with a party, where “control” means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.
Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to imaginmaker.
...
Website refers to Magical Web, accessible from https://imaginmaker.com/
...
<h1 className="text-2xl py-6 mdl:text-3xl text-white">Collecting and Using Your Personal Data</h1>


<h1 className="text-xl py-2 mdl:text-2xl mt-3 text-white">Types of Data Collected</h1>
<h1 className="text-xl py-2 mdl:text-2xl mt-3 text-white">Personal Data</h1>
...
Usage Data</p>
<h1 className="text-xl py-2 mdl:text-2xl mt-3 text-white">Usage Data</h1>
...
<h1 className="text-xl py-2 mdl:text-2xl mt-3 text-white">Information from Third-Party Social Media Services</h1>
...
<h1 className="mt-2">Tracking Technologies and Cookies</h1>
...
<h1 className="mt-2">Necessary / Essential Cookies</h1>
...
<h1 className="mt-2">Cookies Policy / Notice Acceptance Cookies</h1>
<p>Type: Session Cookies
Administered by: Us
Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.
</p>
...
<h1 className="mt-2">Functionality Cookies</h1>
...
<h1 className="mt-2">Use of Your Personal Data</h1>
...
<h1 className="mt-2">Retention of Your Personal Data</h1>
...
<h1 className="mt-2">Transfer of Your Personal Data</h1>
...
<h1 className="mt-2">Delete Your Personal Data</h1>
...
By visiting this page on our website: https://imaginmaker.com/
