      ...
      <div className="relative z-10 w-full min-h-screen bg-black/80 px-4 py-16">
        ...
        <div className="container mx-auto relative bg-zinc-900/80 rounded-3xl p-8 backdrop-blur-sm">
          ...
          <div className="md:hidden">
            ...
            <h2 className="text-xl font-bold text-white text-center mt-12 mb-6">
          ...
          <div className="hidden md:grid lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col justify-center">
              <h2 className={`${satoshi.className} text-[1.2rem] font-bold text-white text-center mb-6`}>
                What Our Clients Say About Us
              </h2>
              ...
              <div className="text-center">
                <Button className="bg-[#6D40FF] shadow-lg hover:bg-[#7D40FF] text-white px-8 py-2 rounded-full font-bold">
                  About Us
                </Button>
              </div>
            </div>
