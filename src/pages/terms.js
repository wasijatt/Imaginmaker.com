                ...
                <div className="max-w-4xl mx-auto px-9 py-8 md:px-6 lg:px-8 ">
                    <div className="space-y-6 mt-12">
                        <div className="flex items-start space-x-4">
                            <Image
                                src="/terms/privacy2.svg"
                                alt="Privacy Policy Logo"
                                width={48}
                                height={48}
                                className="rounded"
                            />
                            <h1 className="md:text-2xl font-semibold text-white">Terms & Conditions</h1>
                        </div>
                        ...
                        <section className="space-y-4">
                            ...
                            <p>
                                ...
                                website if you do not agree to take all of the terms and conditions stated on this page.
                            </p>
                            <p>
                        ...
                        <section className="space-y-4">
                            ...
                            <p>
                                ...
                                our Website. All intellectual property rights are reserved. You may access this from our Website for your
                            ...
                            <p>
                                ...
                                certain areas of the website. We do not filter, edit, publish or review Comments prior to their presence
                                on the website. Comments do not reflect our views and opinions, they reflect the views and opinions of the
                        ...
                        <section className="space-y-4">
                            <h2 className="text-xl font-semibold text-white">Advertising to our Service</h2>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-xl font-semibold text-white">Content Liability</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-xl font-semibold text-white">Removal of links from our website</h2>
                            <p>
