...
const OurServices = () => {
  ...
  return (
    <div className=" bg-[#181818] py-3 lg:py-16 mt-[5vh] m-auto  ">
      ...
      <div className="flex flex-wrap m-auto w-full justify-center items-center mxl:mt-5  lg:w-[65%]">
        ...
        <div className="w-full text-center items-center mt-5">
          <button className={`purpleBg text-white px-7 m-auto mxl:mt-5  rounded-3xl py-2 text-sm lg:text-lg ${style.boxShadow}`}>Get Your Design Done</button>
        </div>
      </div>
    </div>
  );
