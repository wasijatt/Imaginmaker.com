...
const Simplicity = () => {
  return (
    <div className="flex bg-[#191919] px-6 py-6 lg:px-20 lg:py-28 relative  mt-8 lg:mt-16  w-[95%] lg:w-[65%] m-auto rounded-3xl  justify-between items-center">
      ...
      <div className=" w-[30%] mld:w-[45%] text-center flex flex-row     ">
        <Image className="m-auto w-12 lg:w-[200px] absolute -right-0 -top-3 lg:-top-0  rounded-3xl " src="/Plan/but.png" alt="" width={100} height={100} layout="responsive"
          quality={75}
          loading="lazy" />
