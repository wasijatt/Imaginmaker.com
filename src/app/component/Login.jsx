...
const Login = ( ) =>{
    ...
    return(
        ...
        <div className="p-[15%] text-center mdl:text-left">
            <h1 className="text-xl mdl:text-[45px]  font-extrabold">Have an idea?</h1>
            <p className="text-sm mdl:text-xl mt-5 font-bold">Bring your next project to life. Please fill in the information below and one of our consultants will reach out to you today!
</p>
            <form className=" w-full mdl:w-[70%] mt-6" action="" > 
