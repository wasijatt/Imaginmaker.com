    ...
    <div id="capabilities" className="w-[80%] m-auto my-9">
      ...
      <div className=" ">
        <div className="flex w-full mdl:w-[80%] mdl:ml-[5%] m-2 mdl:mt-9 justify-around items-center ">
          <div className="w-1/2"> <Image className="rounded-xl w-[200px] mdl:w-[300px]" src="/our values/Design.jpg" alt="" /> </div>
        ...
        <div className="flex w-full mdl:w-[80%] mdl:ml-[5%] m-2 mdl:mt-9 justify-around items-center  ">
          ...
          <div className="w-1/2"> <Image className="rounded-xl m-auto w-[200px] mdl:w-[300px]" src="/our values/MotionDesign.jpg" alt="" /> </div>
        </div>
        <div className="flex w-full mdl:w-[80%] mdl:ml-[5%] m-2 mdl:mt-9 justify-around items-center ">
          <div className="w-1/2"> <Image className="rounded-xl  w-[200px] mdl:w-[300px]" src="/our values/uiux design.jpg" alt="" /> </div>
          <div className="w-1/2 mdl:w-[40%]">
