      ...
      <div className=" ">
        ...
        <div className="flex w-full lg:w-[80%] lg:ml-[5%] m-2 lg:mt-9 justify-around items-center  ">
          <div className="w-1/2 lg:w-[40%]">
            ...
            <motion.p className="font-normal p-3  text-sm lg:text-xl mt-2 lg:mt-8" style={{ opacity: opacity }}>We&apos;re motion design experts, turning concepts into captivating animations. Our remote team, inspired by successes like cgplus.com, specializes in bringing brands to life with dynamic visuals.</motion.p>
        ...
        <div className="flex w-full lg:w-[80%] lg:ml-[5%] m-2 lg:mt-9 justify-around items-center ">
          ...
          <div className="w-1/2 lg:w-[40%]">
            ...
            <motion.p className="font-normal p-3  text-sm lg:text-xl mt-2 lg:mt-8" style={{ opacity: opacity }}>Crafting seamless experiences is our forte. Specializing in UI/UX design, we transform ideas into intuitive interfaces. From conceptualization to launch, our expertise ensures user-centric designs that elevate digital experiences.</motion.p>
