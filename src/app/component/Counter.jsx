...
//   return (
//     <div className="bg-black text-white flex flex-col justify-center items-center mt-4 lg:mt-12 p-4 lg:px-9 lg:py-15 mb-3">
...
//             className="bg-[#222] text-center w-[90%] sm:w-[70%] md:w-[48%] lg:w-[30%] m-4 py-10 lg:py-20 rounded-3xl"
//           >
//             <Image
